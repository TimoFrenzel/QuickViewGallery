...
<div class="page-bar">
	<?php if ($this->prevImageExists()) {
            echo '<a class="previous-link" href="'.$this->showPrevImageURL(1).'">Previous</a>';
        } else {
            echo '<a class="previous-link-disabled" href="#">Previous</a>';
        } ?>
    <?php if ($this->nextImageExists()) {
            echo '<a class="next-link"  href="'.$this->showNextImageURL(1).'">Next</a>';
        } else {
            echo '<a class="next-link-disabled" href="#">Next</a>';
        } ?>
    <div style="clear: both;"></div>
</div>
